                        ...
                        <div className="flex flex-col lg:flex-row items-center gap-16">
                            <div className="flex-1 space-y-8 text-center lg:text-left">
                                ...
                                <h1 className="text-6xl lg:text-8xl font-extrabold tracking-tighter leading-tight text-foreground">
                                    Bia <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary to-secondary">Faina</span>
                                </h1>
                            ...
                            <div className="flex-1 w-full max-w-lg lg:max-w-none relative">
                                <div className="aspect-[4/5] rounded-[2.5rem] bg-gradient-to-tr from-primary/10 via-white to-secondary/10 shadow-2xl relative border-4 border-white mb-8 lg:mb-0">
                                    ...
                                    <div className="absolute inset-0 overflow-hidden rounded-[2.2rem] group">
                                        <img src="/profile.jpg" alt="Bia Faina - Cantora e Educadora Vocal" className="w-full h-full object-cover object-center scale-[1.02] group-hover:scale-105 transition-transform duration-700" />
                                    </div>
